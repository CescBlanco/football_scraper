...
from football_scraper.providers.scoresway.utils import _create_response, normalize_label, build_qualifier_mapping
from football_scraper.providers.scoresway.data_opta.loaders import load_events_ids, load_qualifiers
