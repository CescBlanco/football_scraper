...
from football_scraper.providers.scoresway.constants import BASE_URL, BASE_URL_COMPETITIONS
from football_scraper.providers.scoresway.utils import _create_driver
